...
const identifikatory = nezaplaceneObjednavky.map((identifikator) => {
	return identifikator.id;
});

console.log(identifikatory);

const emaily = nezaplaceneObjednavky.map((item) => {
	return item.uzivatel.email;
});
console.log(emaily);
